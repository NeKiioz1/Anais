...
class __TwigTemplate_a847109d5a0078534f418399a66dd286728ffb4fa5da33d0a13cc946313ddefb extends \Twig\Template
{
    ...
    {
        // line 27
        $context["ps"] = $this->loadTemplate("@PrestaShop/Admin/macros.html.twig", "@PrestaShop/Admin/Configure/AdvancedParameters/administration.html.twig", 27)->unwrap();
        // line 29
...
";
    ...
    public function block_administration_form_general($context, array $blocks = [])
    {
          ...
          <div class=\"card-block row\">
            <div class=\"card-text\">
              <div class=\"form-group row\">
                ";
        // line 43
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Automatically check for module updates", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("New modules and updates are displayed on the modules page.", [], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 45
        ...
        echo "
              ...
              <div class=\"form-group row\">
                ";
        // line 50
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Check the cookie's IP address", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Check the IP address of the cookie in order to prevent your cookie from being stolen.", [], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 52
        ...
        echo "
              ...
              <div class=\"form-group row\">
                ";
        // line 57
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Lifetime of front office cookies", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Set the amount of hours during which the front office cookies are valid. After that amount of time, the customer will have to log in again.", [], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 59
        ...
        echo "
              ...
              <div class=\"form-group row\">
                ";
        // line 64
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Lifetime of back office cookies", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("When you access your back office and decide to stay logged in, your cookies lifetime defines your browser session. Set here the number of hours during which you want them valid before logging in again.", [], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 66
    ...
    public function block_administration_form_upload_quota($context, array $blocks = [])
    {
        ...
        echo "
              ...
              <div class=\"form-group row\">
                ";
        // line 98
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Maximum size for a downloadable product", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Define the upload limit for a downloadable product (in megabytes). This value has to be lower or equal to the maximum file upload allotted by your server (currently: %size% MB).", ["%size%" => $this->env->getExtension('PrestaShopBundle\Twig\LayoutExtension')->getConfiguration("PS_LIMIT_UPLOAD_FILE_VALUE")], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 100
        ...
        echo "
              ...
              <div class=\"form-group row\">
                ";
        // line 105
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Maximum size for a product's image", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Define the upload limit for an image (in megabytes). This value has to be lower or equal to the maximum file upload allotted by your server (currently: %size% MB).", ["%size%" => $this->env->getExtension('PrestaShopBundle\Twig\LayoutExtension')->getConfiguration("PS_LIMIT_UPLOAD_IMAGE_VALUE")], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 107
    ...
    public function block_administration_form_notifications($context, array $blocks = [])
    {
            ...
            <div class=\"card-text\">
              ...
              <div class=\"row\">
                <div class=\"col\">
                  ";
        // line 134
        echo $this->getAttribute(($context["ps"] ?? null), "infotip", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Notifications are numbered bubbles displayed at the very top of your back office, right next to the shop's name. They display the number of new items since you last clicked on them.", [], "Admin.Advparameters.Help")], "method");
        echo "
                </div>
              </div>
              ...
              <div class=\"form-group row\">
                ";
        // line 139
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Show notifications for new orders", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("This will display notifications when new orders are made in your shop.", [], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 141
        ...
        echo "
              ...
              <div class=\"form-group row\">
                ";
        // line 146
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Show notifications for new customers", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("This will display notifications every time a new customer registers in your shop.", [], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 148
        ...
        echo "
              ...
              <div class=\"form-group row\">
                ";
        // line 153
        echo $this->getAttribute(($context["ps"] ?? null), "label_with_help", [0 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Show notifications for new messages", [], "Admin.Advparameters.Feature"), 1 => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("This will display notifications when new messages are posted in your shop.", [], "Admin.Advparameters.Help")], "method");
        echo "
                <div class=\"col-sm\">
                  ";
        // line 155
    ...
    {
        return new Source("", "@PrestaShop/Admin/Configure/AdvancedParameters/administration.html.twig", "C:\\wamp64\\www\\anais\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Configure\\AdvancedParameters\\administration.html.twig");
    }
}
